export const environment = {
    ...
    // api: 'https://api-claveptal-qa1.azure-api.net/segprocesos',
    // dominioApi: 'https://api-claveptal-qa1.azure-api.net/dominios',
    // posiCatApi: 'https://api-claveptal-qa1.azure-api.net/segprocesos',
    // usuarioApi: 'https://api-claveptal-qa1.azure-api.net/segprocesos',
    // apiSeg: 'https://api-claveptal-qa1.azure-api.net/segprocesos',
    // apiDominio: 'https://api-claveptal-qa1.azure-api.net/dominios',
  ...
  apiTransFiltros: 'https://transfiltrosgenericos.azurewebsites.net/api',
    ...
    api: 'https://segprocesosapi.azurewebsites.net',
    dominioApi: 'https://admdominioapi.azurewebsites.net',
    posiCatApi: 'https://segprocesosapi.azurewebsites.net',
    usuarioApi: 'https://segprocesosapi.azurewebsites.net',
    apiSeg: 'https://segprocesosapi.azurewebsites.net',
